...
public class MusicaController {
	...
	public ResponseEntity<List<Musica>> getIntervalo
	(@PathVariable String ini, @PathVariable String fim) throws Exception{
	SimpleDateFormat formato = new SimpleDateFormat("yyyy-MM-dd");
List<Musica> lista = dao.findByCadastroBetween(formato.parse(ini), formato.parse(fim));
if (lista.size()==0) {
